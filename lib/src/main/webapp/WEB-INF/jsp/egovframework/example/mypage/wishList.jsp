    ...
    <body class="d-flex flex-column">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8 col-xxl-6">
                            <div class="text-center my-5">
                                ...
                                <h1 class="fw-bolder mb-3">희망도서 신청내역</h1>
                                <p class="lead fw-normal text-muted mb-4">${sessionScope.userid}님의 희망도서 목록입니다.</p>
                                
                                <!-- 검색 -->
                                <form id="searchForm" action="/mypage/wishList.do" method="get">
                                    <div class="searchBox">
                                    
                                    	<input class="insertSearch" id="searchBar" name="sKey" type="text" placeholder="제목 혹은 저자를 검색하세요" value="">
                                    	<div class="searchBtn">
            ...
            <section class="py-5 bg-light">
                <div class="container px-5 my-5">
					...
					<ul class="pagination">
					    ...
					    <c:otherwise>
					    	<li class="page-item"><a class="page-link" href="/mypage/wishList.do?kwd=${pinfo.sKey}&page=${pageInfo.currentPageNo-1}">이전</a></li>
					    </c:otherwise>
					    </c:choose>
					    ...
					    <c:forEach begin="${pageInfo.firstPageNoOnPageList}" end="${pageInfo.lastPageNoOnPageList}" var="i" step="1">
						    <c:choose>
						        ...
						        <c:otherwise>
						        	<li class="page-item"><a class="page-link" href="/mypage/wishList.do?kwd=${pinfo.sKey}&page=${i}">${i}</a></li>
						        </c:otherwise>
						...
						<c:choose>
				            ...
				            <c:otherwise>
				            	<li class="page-item"><a class="page-link" href="/mypage/wishList.do?kwd=${pinfo.sKey}&page=${i}">다음</a></li>
				            </c:otherwise>
				        </c:choose>
        ...
        $(function() {
            ...
            $('.wishBtn').on('click', function(event){
    	        ...
    	        var wishId = row.find('input[name="wishId"]').val();
                var userid = "${sessionScope.userid}";
                
                if (userid != "") {
		            $.ajax({
						type: 'get',
						url: '/mypage/wishDelete.do',
						data: {
						    wishId: wishId,
						    userid: userid
						}, 
