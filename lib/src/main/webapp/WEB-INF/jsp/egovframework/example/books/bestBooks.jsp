			            ...
			            $.ajax({
							...
							success: function (response) {
								if (response.status === 'overdue') {
								    sweet.errorAlert('연체 상태입니다.', response.dueCount + '일 동안 대여할 수 없습니다.', function() { location.href = '/main.do'; });
		            ...
		            $.ajax({
						...
						success: function (response) {
							if (response.status === 'overdue') {
					            ...
					            sweet.successAlert('','대출되었습니다.', function() { location.href = '/books/bestBooks.do'; });
		                    }
					    }
					});
		        } else {
